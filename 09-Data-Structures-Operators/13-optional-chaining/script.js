...
// only if the before element of question mark exits, then it goes to next , otherwise immediately return undefined
console.log(restaurant.openingHours.mon?.open);
console.log(restaurant.openingHours?.mon?.open);
...
const user = [{ name: 'Jonas', email: 'hello@gamil.io ' }];
// const user = [];

console.log(user[0]?.name ?? "User array doesn't exist empty ");
