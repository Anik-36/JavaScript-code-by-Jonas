...
// Split and Join
console.log('a+very+nice+string'.split('+')); // it forms an array
...
capitalizeName('md. anisur rahman anik');

// Padding
// adding some string to get the expected length that is given to the arguments in the method
